...
<div>
    <h4 align="right" style="color:green;">Helpline no--8768446114 </h4></div>
	<h1 align="center" style="color:purple;">Welcome to Railway Reservation System</h1></div>
<table>
<tr>
...
<tr>
<td>
<div class="saikat"><p>The Customers are required to register on the server for getting access to the database and query result retrieval. Upon registration, each user has an account which is essentially the ‘view level’ for the customer. The account contains comprehensive information of the user entered during registration and permits the customer to get access to his past reservations, enquire about travel fare and availability of seats, make afresh reservations, update his account details.
